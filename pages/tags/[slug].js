...
const Tag = ({ tag, blogs,query }) => {
    ...
    const head = () => (
        <Head>
            ...
            <meta name="description" content={ `${tag.name} tag have all the best details you want about your query `} />
            <link rel="canonical" href={`${DOMAIN}/categories/${query.slug}`} />
            <meta property="og:title" content={`${tag.name} | ${APP_NAME}`} />
            <meta name="og:description" content={`${tag.name} have all the best details you want about your query `} />
